    ...
    return (
        <form onSubmit={sendEmail} className={styles.contact__form} ref={formRef}>
            ...
            <label className={styles.contact__checkbox}>
                ...
                <span className={styles.contact__checkbox__text}>Натиснувши на кнопку «Відправити замовлення», я погоджуюся з <Link href='/privacy-policy' passHref legacyBehavior><a className={styles.contact__checkbox__link}>Політикой конфіденційності</a></Link> та даю <Link legacyBehavior href='/personal-data-of-clients' passHref><a className={styles.contact__checkbox__link}>Згоду на обробку персональних даних.</a></Link></span>
            </label>
        </form>
    );
}
